...
export const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "ズバリ「圧倒的な手離れの良さと、感情的満足感」が違います。フリマアプリでの革ジャン売却は、アームホール幅や着丈、傷の位置をルーペレベルで確認する購入希望者からの細かい質問攻め、大幅な値下げ交渉、サイズ違いによる返品トラブル、発送前のオイルケアや梱包の手間など、多大なストレスが伴います。ReValue by Liugoo Leathersなら、それら面倒なやり取りは一切なし。LINEで写真を送って、箱に詰めて送るだけ。さらに大事にしてくれる次のオーナーへ確実にお繋ぎします。"
  }
];
