...
function StepHeader({ step, label, sub }: { step: number; label: string; sub?: string }) {
  return (
    <div>
      <span className="text-xs uppercase tracking-wider text-camel-500 font-mono block mb-1">
        Step 0{step} / {label}
      </span>
...
function NextBtn({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="bg-burgundy-500 hover:bg-burgundy-400 active:bg-burgundy-600 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold py-3 px-6 rounded-xl flex items-center gap-2 transition-all cursor-pointer"
    >
...
export default function OfficialAppraisal() {
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  return (
    <div className="w-full bg-[#11131c] border border-camel-500/20 rounded-2xl overflow-hidden shadow-2xl relative">
      {/* top accent */}
            ...
            return (
              <div
                ...
                className={`px-2 py-1 rounded text-[10px] font-mono ${
                  step === s
                    ? "bg-camel-500 text-black font-bold shadow shadow-camel-500/30"
                    : step > s
      ...
      <div className="p-6 sm:p-8 min-h-[420px] flex flex-col">
        ...
        {!gasData && !loadError && (
          <div className="flex-1 flex flex-col items-center justify-center gap-3 py-12">
            <Loader2 className="w-8 h-8 text-camel-500 animate-spin" />
        ...
        {loadError && (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 py-12">
            ...
            <button
              ...
              className="text-xs text-camel-400 border border-camel-500/30 px-4 py-2 rounded-lg hover:bg-camel-500/10 transition-all cursor-pointer"
            >
              再読み込み
            </button>
          </div>
        ...
        {gasData && (
          <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    ブランド: <span className="text-camel-400">{selectedBrand}</span>
                  </p>
                </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ${
                          selectedModel === item.model ? "border-camel-500 bg-camel-500" : "border-gray-600"
                        }`}>
                          {selectedModel === item.model && (
                      ...
                      <span className="text-xs font-mono text-camel-400 shrink-0">
                  ...
                  {CONDITION_OPTIONS.map((opt) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-xs font-mono text-camel-400/70 shrink-0">
                          × {rate.toFixed(1)}
                        </span>
                      </button>
                    );
            ...
            {step === 4 && (
              ...
              >
                      ...
                      return (
                        <button key={s} onClick={() => setSelectedSize(s)}
                          className={`py-3 rounded-xl border text-center transition-all cursor-pointer ${
                            selectedSize === s
                              ? "bg-camel-500/10 border-camel-500/80"
                ...
                <div className="pt-4 border-t border-white/5 flex justify-between gap-3">
                  ...
                  <button
                    onClick={() => setStep(5)}
                    className="flex-1 bg-gradient-to-r from-burgundy-600 to-burgundy-500 hover:from-burgundy-500 hover:to-burgundy-400 text-white font-black py-3 px-6 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-burgundy-500/20 cursor-pointer transition-all"
                  >
            ...
            {step === 5 && (
              ...
              >
                {/* Result card */}
                <div className="bg-gradient-to-br from-[#1c1f2e] to-[#121420] border border-camel-500/30 p-5 sm:p-6 rounded-2xl relative overflow-hidden">
                  <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-camel-500 via-camel-400 to-camel-500" />
                  ...
                  <div className="grid grid-cols-2 gap-3 pb-4 border-b border-white/5 text-xs mb-4">
                    ...
                    <div>
                      ...
                      <span className="font-bold text-camel-400">{selectedCondition}</span>
                    </div>
                    <div>
                  ...
                  <div className="text-center py-5 border-t border-white/5">
                    ...
                    <span className="text-4xl sm:text-5xl font-mono font-black text-camel-400 tracking-tight drop-shadow-[0_0_20px_rgba(193,154,107,0.35)]">
                ...
                <div className="bg-camel-500/5 border border-camel-500/15 rounded-xl p-3 text-xs text-gray-400 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    onClick={() => setStep(6)}
                    className="flex-1 bg-gradient-to-r from-burgundy-600 to-burgundy-500 hover:from-burgundy-500 hover:to-burgundy-400 text-white font-black py-4 px-6 rounded-xl flex items-center justify-center gap-2 shadow-xl shadow-burgundy-500/25 text-base cursor-pointer transition-all hover:scale-[1.01]"
                  >
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    査定金額:{" "}
                    <span className="text-camel-400 font-mono font-bold text-sm">
                      ¥{assessmentAmount.toLocaleString()}
                    </span>
                  </p>
                </div>
                ...
                <div className="space-y-3 flex-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      placeholder="山田 太郎"
                      className="w-full bg-white/[0.03] border border-white/10 focus:border-camel-500/60 focus:outline-none text-white placeholder-gray-600 px-4 py-3 rounded-xl text-sm transition-all"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="1500001"
                        maxLength={7}
                        className="w-full bg-white/[0.03] border border-white/10 focus:border-camel-500/60 focus:outline-none text-white placeholder-gray-600 px-4 py-3 rounded-xl text-sm transition-all pr-10"
                      />
                      {postalLoading && (
                        <Loader2 className="absolute right-3 top-3.5 w-4 h-4 text-camel-500 animate-spin" />
                      )}
                    </div>
                ...
                <div className="pt-4 border-t border-white/5 flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="flex-1 bg-gradient-to-r from-burgundy-600 to-burgundy-500 hover:from-burgundy-500 hover:to-burgundy-400 disabled:opacity-50 text-white font-black py-4 px-6 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-burgundy-500/20 text-base cursor-pointer transition-all"
                  >
                    {submitting ? (
            ...
            {step === 7 && (
              ...
              >
                <motion.div
                  ...
                  className="w-20 h-20 rounded-full bg-camel-500/10 border-2 border-camel-500/40 flex items-center justify-center"
                >
                  <CheckCircle2 className="w-10 h-10 text-camel-400" />
                </motion.div>

                <div className="space-y-2">
                  <h4 className="text-xl font-black text-white">お申し込みを受け付けました！</h4>
                  <p className="text-sm text-gray-400 leading-relaxed max-w-sm">
                    <span className="text-camel-400 font-bold">{customerName}</span> 様のご登録メールアドレスに確認メールをお送りしました。
                  </p>
                ...
                <div className="bg-[#181a26] border border-white/5 rounded-xl p-4 text-xs text-left space-y-2 w-full max-w-xs">
                  <p className="text-camel-400 font-bold text-center text-sm mb-3">査定概要</p>
                  ...
                  <div className="flex justify-between font-bold pt-2 border-t border-white/5">
                    ...
                    <span className="text-camel-400 font-mono text-base">¥{assessmentAmount.toLocaleString()}</span>
                  </div>
                </div>
                ...
                <div className="space-y-3 w-full text-center">
                  ...
                  <button
                    onClick={handleReset}
                    className="text-xs text-camel-500 hover:text-camel-400 flex items-center gap-1 mx-auto cursor-pointer transition-all"
                  >
